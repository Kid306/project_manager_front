export default {
  ...
  router: {
    ...
    workflow: {
      ...
      ProcinstParamesExecutionSetRoute: '任务执行路径',
      ProcinstParamesStartSetRoute: '任务启动路径',
      ProcdefListForBizStart: '任务启动模型',
      ...
      modelCenter: '流程设计',
      workflowEditorIndex: '流程设计',
      ModelMng: '模型管理',
      DeploymentMng: '发布管理',
      ProcdefSuspend: '激活/挂起',
      ProcdefListForParames: '模型设置',
      BizModelMng: '关联业务'
    },
    order: {
      MenuModuleBranchMng: '已购模块(平台)',
      MoOrderMng: '订单列表(平台)',
      MyMoOrderMng: '我的订单',
      MyPurchaseMng: '购买产品',
      CreateOrder: '创建订单',
    ...
    form: {
      ...
      FormDefMng: '表单中心',
      FormDesign: '表单设计',
      FormDesignExpand: '表单设计',
      FormDefIndex: '表单首页',  
      FormDesignRoute: '表单路由设计',
      FormDataAddRoute: '数据填报',
      FormDataMng: '智能表单数据管理',
      FormDetail: '表单明细',
      FormEdit: '表单编辑'
    },
    dm: {
      ...
      dataTable: '表格数据',
      TableStruct: '表格结构',
      tableDataList: '表格数据查询',
      dataSetCreate: '创建数据集',
      dataSetDataList:'数据集数据列表'
    },
    sys: {
      AppMdpMng: '开户',
      OpenAccountMng: '开放账户管理',
      ...
      plat: '平台管理',
      PlatformMng: '平台管理',
      UserValidInfoMngForPerson: '个人认证审核',
      UserValidInfoMngForBranch: '企业认证审核',
      ...
      myInviteUserTpa: '我邀请的用户',
      userTpaIndex: '第三方用户查询',
      MaxUsersSet: '用户数调整',
      UserJoinApprove:'加入审核',
      UserJoinRequireList:'加入列表',
    }
  },
  analysis: {
    newUser: '新增用户',
  ...
  sys: {
    api: {
      ...
      errMsg401: '用户没有权限（令牌过期、用户名密码错误等）,请重新登录！',
