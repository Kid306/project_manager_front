<template>
  <div class="panel-tab__content">
    ...
    <div class="element-drawer__button">
      ...
      <XButton
        ...
        title="选择监听器"
        size="small"
        @click="$refs['processListenerDialogRef'].open()"
      />
    </div>
  ...
  <!-- 选择弹窗 -->
  <MdpDialog ref="processListenerDialogRef">
    <MdpSelect itemCode="wf_process_listener" @change2="selectProcessListener"/>
  </MdpDialog>
</template>
...
const selectProcessListener = (listener) => {
  ...
  processListenerDialogRef.value.close()
