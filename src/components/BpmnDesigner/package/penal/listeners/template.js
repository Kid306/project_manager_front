export const template = (isTaskListener) => {
  ...
  <div class="panel-tab__content">
    <el-table v-adaptive :data="elementListenersList" size="small" border>
    ...
    <!-- 监听器 编辑/创建 部分 -->
    <el-drawer :visible="listenerFormModelVisible" title="执行监听器" :size="width + 'px'" append-to-body destroy-on-close>
      ...
      <el-table v-adaptive :data="fieldsListOfListener" size="small" max-height="240" border fit style="flex: none">
        <el-table-column label="序号" width="50px" type="index" />
    ...
    <!-- 注入西段 编辑/创建 部分 -->
    <el-dialog title="字段配置" :visible="listenerFieldFormModelVisible" width="600px" append-to-body destroy-on-close>
