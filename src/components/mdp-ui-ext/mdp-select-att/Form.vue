        ...
        <el-form :model="editForm"  label-width="120px" :rules="editFormRules" ref="editFormRef" :inline="false"> 
            ...
            <span v-if="currOpType!='add'">
                <el-form-item label="编号" prop="id">
                    <el-input show-style="origin" v-model="editForm.id" placeholder="编号" :maxlength="50" @change="editSomeFields(editForm,'id',$event)" :disabled="disField"/>
                </el-form-item>
                <el-form-item label="附件名称" prop="name">
                    ...
                    <el-input v-else show-style="origin" v-model="editForm.name" placeholder="附件名称" :maxlength="100" @change="editSomeFields(editForm,'name',$event)" :disabled="disField"/>
                </el-form-item>
                <el-form-item label="访问路径" prop="url">
                    <el-input show-style="origin" v-model="editForm.url" placeholder="访问路径" :maxlength="250" @change="editSomeFields(editForm,'url',$event)" :disabled="disField"/>
                </el-form-item>
                ...
                <el-form-item label="主题" prop="archiveType">
                    <mdp-select item-code="categoryType" show-style="origin" v-model="editForm.archiveType" placeholder="主题" :maxlength="1" @change="editSomeFields(editForm,'archiveType',$event)" :disabled="disField"/>
                </el-form-item>
                <el-form-item label="存储名字" prop="storeName">
                    <el-input show-style="origin" v-model="editForm.storeName" placeholder="存储名字" :maxlength="50" @change="editSomeFields(editForm,'storeName',$event)" :disabled="disField"/>
                </el-form-item>
                ...
                <el-form-item label="内容加速器访问路径" prop="cdnUrl">
                    <el-input show-style="origin" v-model="editForm.cdnUrl" placeholder="内容加速器访问路径" :maxlength="250" @change="editSomeFields(editForm,'cdnUrl',$event)" :disabled="disField"/>
                </el-form-item>
                <el-form-item label="是否图片" prop="isImg">
                    <el-checkbox v-model="editForm.isImg" true-label="1" false-label="0" @change="editSomeFields(editForm,'isImg',$event)" :disabled="disField">是否图片</el-checkbox>

                </el-form-item>
                <el-form-item label="档案主编号" prop="archiveId">
                    <el-input show-style="origin" v-model="editForm.archiveId" placeholder="档案主编号" :maxlength="150" @change="editSomeFields(editForm,'archiveId',$event)" :disabled="disField"/>
                </el-form-item>
                <el-form-item label="是否使用CDN" prop="isCdn" v-show="editForm.isImg=='1'">
                    <el-checkbox  v-model="editForm.isCdn" true-label="1" false-label="0" @change="editSomeFields(editForm,'isCdn',$event)" :disabled="disField">是否使用CDN加速</el-checkbox>
                </el-form-item>
                <el-form-item label="根目录" prop="rootPath">
                    <el-input show-style="origin" v-model="editForm.rootPath" placeholder="根目录" :maxlength="250" @change="editSomeFields(editForm,'rootPath',$event)" :disabled="disField"/>
                </el-form-item>
                ...
                <el-form-item label="分类编号" prop="categoryId">
                    <el-input show-style="origin" v-model="editForm.categoryId" placeholder="分类编号" :maxlength="50" @change="editSomeFields(editForm,'categoryId',$event)" :disabled="disField"/>
                </el-form-item>
                <el-form-item label="业务编号等" prop="bizId">
                    <el-input show-style="origin" v-model="editForm.bizId" placeholder="业务编号、产品编号、商品编号等" :maxlength="150" @change="editSomeFields(editForm,'bizId',$event)" :disabled="disField"/>
                </el-form-item>
                <el-form-item label="业务名称等" prop="remark">
                    <el-input show-style="origin" v-model="editForm.remark" placeholder="业务名称、产品名称、商品名称等" :maxlength="1000" @change="editSomeFields(editForm,'remark',$event)" :disabled="disField"/>
                </el-form-item>
                <el-form-item label="云用户机构编号" prop="branchId">
                    <el-input show-style="origin" v-model="editForm.branchId" placeholder="云用户机构编号" :maxlength="50" @change="editSomeFields(editForm,'branchId',$event)" :disabled="disField"/>
                </el-form-item> 
                ...
                <el-form-item label="部门编号" prop="deptid">
                    <el-input show-style="origin" v-model="editForm.deptid" placeholder="部门编号" :maxlength="50" @change="editSomeFields(editForm,'deptid',$event)" :disabled="disField"/>
                </el-form-item>
            </span>
        </el-form> 
