...
//调整企业的权益
editSomeFieldsBranchInterests: params => { return axios.post(`${sysBase}/mdp/sys/branchInterests/editSomeFields`, params); },
//加入企业申请
addUserJoinRequire: params => { return axios.post(`${sysBase}/mdp/sys/userJoinRequire/add`, params); },
//加入申请查询
listUserJoinRequire: params => { return axios.post(`${sysBase}/mdp/sys/userJoinRequire/add`, params); },
//查询登陆日志  
...
//查询所有模块
getAllMenuModule : params => { return axios.get(`${sysBase}/mdp/menu/menuModule/list`, {params: params }); },

//查询已购买的模块
getBuyMenuModule : params => { return axios.get(`${sysBase}/mdp/menu/menuModuleBranch/list`, {params: params }); },
