		...
		<!--编辑界面 XmIterationMenu 迭代定义-->
			<el-form :model="editForm"  label-width="120px" :rules="editFormRules" ref="editForm">
				...
				<el-form-item label="对应的迭代编号" prop="iterationId">
					<el-input v-model="editForm.iterationId" placeholder="对应的迭代编号"/>
				</el-form-item>
				<el-form-item label="需求编号" prop="menuId">
					<el-input v-model="editForm.menuId" placeholder="需求编号"/>
				</el-form-item>
				...
				<el-form-item label="关联状态0不再关联1正常关联" prop="relStatus">
					<el-input v-model="editForm.relStatus" placeholder="关联状态0不再关联1正常关联"/>
				</el-form-item>
				<el-form-item>
