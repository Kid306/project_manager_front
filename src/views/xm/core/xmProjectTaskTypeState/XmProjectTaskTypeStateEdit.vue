		...
		<!--编辑界面 XmProjectTaskTypeState 按任务类型汇总-->
			<el-form :model="editForm"  label-width="120px" :rules="editFormRules" ref="editForm">
				<el-form-item label="项目编号" prop="projectId">
					<el-input v-model="editForm.projectId" placeholder="项目编号"/>
				</el-form-item>
				<el-form-item label="项目名称" prop="projectName">
					<el-input v-model="editForm.projectName" placeholder="项目名称"/>
				</el-form-item>
				<el-form-item label="任务类型" prop="taskType">
					<el-input v-model="editForm.taskType" placeholder="任务类型"/>
				</el-form-item>
				<el-form-item label="工作量" prop="planWorkload">
					<el-input v-model="editForm.planWorkload" placeholder="工作量"/>
				</el-form-item>
				<el-form-item label="预算金额" prop="planAmount">
					<el-input v-model="editForm.planAmount" placeholder="预算金额"/>
				</el-form-item>
				<el-form-item label="实际完成工作量" prop="actWorkload">
					<el-input v-model="editForm.actWorkload" placeholder="实际完成工作量"/>
				</el-form-item>
				<el-form-item label="实际完成金额" prop="actAmount">
					<el-input v-model="editForm.actAmount" placeholder="实际完成金额"/>
				</el-form-item>
				...
				<el-form-item label="业务日期YYYY-MM-DD型" prop="bizDate">
					<el-input v-model="editForm.bizDate" placeholder="业务日期YYYY-MM-DD型"/>
				</el-form-item>
				...
				<el-form-item label="外购资金预算" prop="planOuserAt">
					<el-input v-model="editForm.planOuserAt" placeholder="外购资金预算"/>
				</el-form-item>
				<el-form-item label="内购资金预算" prop="planIuserAt">
					<el-input v-model="editForm.planIuserAt" placeholder="内购资金预算"/>
				</el-form-item>
				<el-form-item label="实际外购成本" prop="actOuserAt">
					<el-input v-model="editForm.actOuserAt" placeholder="实际外购成本"/>
				</el-form-item>
				<el-form-item label="实际内购成本" prop="actIuserAt">
					<el-input v-model="editForm.actIuserAt" placeholder="实际内购成本"/>
				</el-form-item>
				<el-form-item label="计划外购工作量" prop="planOuserWorkload">
					<el-input v-model="editForm.planOuserWorkload" placeholder="计划外购工作量"/>
				</el-form-item>
				<el-form-item label="计划内购工作量" prop="planIuserWorkload">
					<el-input v-model="editForm.planIuserWorkload" placeholder="计划内购工作量"/>
				</el-form-item>
				<el-form-item label="实际外购工作量" prop="actOuserWorkload">
					<el-input v-model="editForm.actOuserWorkload" placeholder="实际外购工作量"/>
				</el-form-item>
				<el-form-item label="实际内购工作量" prop="actIuserWorkload">
					<el-input v-model="editForm.actIuserWorkload" placeholder="实际内购工作量"/>
				</el-form-item>
				<el-form-item label="计划非人力成本" prop="planNouserAt">
					<el-input v-model="editForm.planNouserAt" placeholder="计划非人力成本"/>
				</el-form-item>
				<el-form-item label="实际非人力成本" prop="actNouserAt">
					<el-input v-model="editForm.actNouserAt" placeholder="实际非人力成本"/>
				</el-form-item>
				<el-form-item label="主键" prop="id">
					<el-input v-model="editForm.id" placeholder="主键"/>
				</el-form-item>
				<el-form-item>
