		...
		<!--编辑界面 XmTaskExecuser xm_task_execuser-->
			<el-form :model="editForm"  label-width="120px" :rules="editFormRules" ref="editForm">
				...
				<el-form-item label="执行人状态" prop="status">
					<mdp-select itemCode="projectTaskExecuserStatus" :disabled="editForm.status == '2'"  placeholder="选择状态" v-model="editForm.status"/>
				
				</el-form-item>
				<el-form-item label="加入时间" prop="startTime">
					<el-date-picker type="datetime" placeholder="选择日期" v-model="editForm.startTime" :clearable="false" value-format="YYYY-MM-DD HH:mm:ss" format="YYYY-MM-DD HH:mm:ss" />
				</el-form-item>
				<el-form-item label="离开时间" prop="endTime">
					<el-date-picker type="datetime" placeholder="选择日期" v-model="editForm.endTime" :clearable="false" value-format="YYYY-MM-DD HH:mm:ss" format="YYYY-MM-DD HH:mm:ss" />
				</el-form-item>
				<el-form-item label="备注" prop="remarks">
					<el-input v-model="editForm.remarks" placeholder="备注"/>
				</el-form-item>
				<el-form-item label="结算金额" prop="settleAmount">
					<el-input v-model="editForm.settleAmount" type="number" placeholder="结算金额"/>
				</el-form-item>
				<el-form-item label="结算工时" prop="settleHour">
					<el-input v-model="editForm.settleHour" type="number" placeholder="结算工时"/>
				</el-form-item>
				<el-form-item label="结算状态" prop="settleStatus">
					<mdp-select show-style="tag" itemCode="projectTaskSettleStatus" style="width:100%;" placeholder="选择结算状态" v-model="editForm.settleStatus"/>
				</el-form-item>
				<el-form-item label="结算时间" prop="settleTime">
					<el-date-picker type="datetime" placeholder="选择日期" v-model="editForm.settleTime"  value-format="YYYY-MM-DD HH:mm:ss" format="YYYY-MM-DD HH:mm:ss" />
				</el-form-item>
				<el-form-item label="匹配指数" prop="remarks">
					<el-input v-model="editForm.matchScore" type="number" placeholder="匹配指数" />
				</el-form-item>
