		...
		<!--编辑界面 XmAttachment xm_attachment-->
			<el-form :model="editForm"  label-width="120px" :rules="editFormRules" ref="editForm">
				...
				<el-form-item label="附件来源类型，0任务，1缺陷，2文档" prop="originType">
					<el-input v-model="editForm.originType" placeholder="附件来源类型，0任务，1缺陷，2文档"/>
				</el-form-item>
				<el-form-item label="来源id" prop="originId">
					<el-input v-model="editForm.originId" placeholder="来源id"/>
				</el-form-item>
				<el-form-item label="附件名字" prop="name">
					<el-input v-model="editForm.name" placeholder="附件名字"/>
				</el-form-item>
				<el-form-item label="附件地址" prop="addr">
					<el-input v-model="editForm.addr" placeholder="附件地址"/>
				</el-form-item>
				<el-form-item label="附件类型" prop="type">
					<el-input v-model="editForm.type" placeholder="附件类型"/>
				</el-form-item>
				<el-form-item label="备注说明" prop="remark">
					<el-input v-model="editForm.remark" placeholder="备注说明"/>
				</el-form-item>
				<el-form-item>
