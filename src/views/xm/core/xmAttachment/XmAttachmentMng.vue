<template>
		...
		<el-row>
			...
			<el-button type="primary" v-loading="load.list" :disabled="load.list==true" @click="searchXmAttachments">查询</el-button>
		...
		<el-row class="page-main ">
			...
			<el-table :data="xmAttachments" @sort-change="sortChange" highlight-current-row v-loading="load.list" border @selection-change="selsChange" @row-click="rowClick" style="width: 100%;">
				...
				<el-table-column prop="originType" label="附件来源类型，0任务，1缺陷，2文档" min-width="80"  />
				<el-table-column prop="originId" label="来源id" min-width="80"  />
				<el-table-column prop="name" label="附件名字" min-width="80"  />
				<el-table-column prop="addr" label="附件地址" min-width="80"  />
				<el-table-column prop="type" label="附件类型" min-width="80"  />
				<el-table-column prop="remark" label="备注说明" min-width="80"  />
			...
			<mdp-dialog title="编辑xm_attachment" v-model="editFormVisible"  size="50%"  append-to-body   :close-on-click-modal="false">
				  <xm-attachment-edit :xm-attachment="editForm" :visible="editFormVisible" @cancel="editFormVisible=false" @submit="afterEditSubmit" />
			</mdp-dialog>

			<!--新增 XmAttachment xm_attachment界面-->
			<mdp-dialog title="新增xm_attachment" v-model="addFormVisible"  size="50%"  append-to-body   :close-on-click-modal="false">
				<xm-attachment-add :xm-attachment="addForm" :visible="addFormVisible" @cancel="addFormVisible=false" @submit="afterAddSubmit" />
			</mdp-dialog>
		</el-row>
...
<script>
	...
	import  XmAttachmentAdd from './XmAttachmentAdd.vue';//新增界面
	import  XmAttachmentEdit from './XmAttachmentEdit.vue';//修改界面
