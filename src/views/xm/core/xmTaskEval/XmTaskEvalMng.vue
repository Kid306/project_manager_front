<template>
		...
		<el-row>
			...
			<el-button v-loading="load.list" :disabled="load.list==true" @click="searchXmTaskEvals" icon="search">查询</el-button>
		...
		<el-row class="padding-top">
			...
			<el-table ref="xmTaskEvalTable" :data="xmTaskEvals" v-adaptive="{bottom:50}" @sort-change="sortChange" highlight-current-row v-loading="load.list" border @selection-change="selsChange" @row-click="rowClick" style="width: 100%;">
				...
				-->
				<el-table-column prop="id" label="评价" min-width="120" show-overflow-tooltip  fixed="left" />
		...
		<el-row>
			...
			<mdp-dialog title="编辑xm_task_eval" v-model="editFormVisible"  width="60%"  append-to-body   :close-on-click-modal="false">
			    <xm-task-eval-edit op-type="edit" :xm-task-eval="editForm" :visible="editFormVisible" @cancel="editFormVisible=false" @submit="afterEditSubmit" />
			</mdp-dialog>

			<!--新增 XmTaskEval xm_task_eval界面-->
			<mdp-dialog title="新增xm_task_eval" v-model="addFormVisible"  width="60%"  append-to-body  :close-on-click-modal="false">
			    <xm-task-eval-edit op-type="add" :visible="addFormVisible" @cancel="addFormVisible=false" @submit="afterAddSubmit" />
			</mdp-dialog>
	    </el-row>
...
import { listXmTaskEval, delXmTaskEval, batchDelXmTaskEval,editSomeFieldsXmTaskEval } from '@/api/xm/core/xmTaskEval';
import  XmTaskEvalEdit from './XmTaskEvalEdit.vue';//新增修改界面
