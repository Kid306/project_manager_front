		...
		<el-row>
			...
			<el-form :model="addForm"  label-width="120px" :rules="addFormRules" ref="addForm">
				...
				<el-form-item label="机构编码" prop="branchId">
					<el-input v-model="addForm.branchId" placeholder="机构编码" />
				</el-form-item>
				<el-form-item label="指标编号" prop="kpiIndex">
					<el-input v-model="addForm.kpiIndex" placeholder="指标编号" />
				</el-form-item>
				<el-form-item label="指标名称" prop="kpiName">
					<el-input v-model="addForm.kpiName" placeholder="指标名称" />
				</el-form-item>
				<el-form-item label="最大值" prop="maxValue">
					<el-input v-model="addForm.maxValue" placeholder="最大值" />
				</el-form-item>
				<el-form-item label="最小值" prop="minValue">
					<el-input v-model="addForm.minValue" placeholder="最小值" />
				</el-form-item>
				<el-form-item label="kpi主表主键" prop="kpiId">
					<el-input v-model="addForm.kpiId" placeholder="kpi主表主键" />
				</el-form-item>
				<el-form-item label="得分0~10分" prop="score">
					<el-input-number v-model="addForm.score" :min="0" :max="200" />
				</el-form-item>
				<el-form-item label="评分日期" prop="scoreDate">
					<el-date-picker type="date" placeholder="选择日期" v-model="addForm.scoreDate" value-format="YYYY-MM-DD HH:mm:ss" format="YYYY-MM-DD" />
				</el-form-item>
				<el-form-item label="流程状态" prop="bizFlowState">
					<el-input v-model="addForm.bizFlowState" placeholder="流程状态" />
				</el-form-item>
				<el-form-item label="流程实例编号" prop="bizProcInstId">
					<el-input v-model="addForm.bizProcInstId" placeholder="流程实例编号" />
				</el-form-item>
				<el-form-item label="kpi当前值" prop="kpiValue">
					<el-input v-model="addForm.kpiValue" placeholder="kpi当前值" />
				</el-form-item>
				<el-form-item label="创建日期" prop="cdate">
					<el-date-picker type="date" placeholder="选择日期" v-model="addForm.cdate" value-format="YYYY-MM-DD HH:mm:ss" format="YYYY-MM-DD" />
				</el-form-item>
				...
				<el-form-item label="考核方式0月1季度3半年4一年" prop="calcType">
					<el-input v-model="addForm.calcType" placeholder="考核方式0月1季度3半年4一年" />
				</el-form-item>
				<el-form-item label="下次考核开始时间" prop="nextCalcDate">
					<el-date-picker type="date" placeholder="选择日期" v-model="addForm.nextCalcDate" value-format="YYYY-MM-DD HH:mm:ss" format="YYYY-MM-DD" />
				</el-form-item>
				<el-form-item>
