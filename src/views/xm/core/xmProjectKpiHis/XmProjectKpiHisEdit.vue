		...
		<!--编辑界面 XmProjectKpiHis xm_project_kpi_his-->
			<el-form :model="editForm"  label-width="120px" :rules="editFormRules" ref="editForm">
				...
				<el-form-item label="机构编码" prop="branchId">
					<el-input v-model="editForm.branchId" placeholder="机构编码"/>
				</el-form-item>
				<el-form-item label="指标编号" prop="kpiIndex">
					<el-input v-model="editForm.kpiIndex" placeholder="指标编号"/>
				</el-form-item>
				<el-form-item label="指标名称" prop="kpiName">
					<el-input v-model="editForm.kpiName" placeholder="指标名称"/>
				</el-form-item>
				<el-form-item label="最大值" prop="maxValue">
					<el-input v-model="editForm.maxValue" placeholder="最大值"/>
				</el-form-item>
				<el-form-item label="最小值" prop="minValue">
					<el-input v-model="editForm.minValue" placeholder="最小值"/>
				</el-form-item>
				<el-form-item label="kpi主表主键" prop="kpiId">
					<el-input v-model="editForm.kpiId" placeholder="kpi主表主键"/>
				</el-form-item>
				<el-form-item label="得分0~10分" prop="score">
					<el-input-number v-model="editForm.score" :min="0" :max="200" />
				</el-form-item>
				<el-form-item label="评分日期" prop="scoreDate">
					<el-date-picker type="date" placeholder="选择日期" v-model="editForm.scoreDate"  value-format="YYYY-MM-DD HH:mm:ss" format="YYYY-MM-DD" />
				</el-form-item>
				<el-form-item label="流程状态" prop="bizFlowState">
					<el-input v-model="editForm.bizFlowState" placeholder="流程状态"/>
				</el-form-item>
				<el-form-item label="流程实例编号" prop="bizProcInstId">
					<el-input v-model="editForm.bizProcInstId" placeholder="流程实例编号"/>
				</el-form-item>
				<el-form-item label="kpi当前值" prop="kpiValue">
					<el-input v-model="editForm.kpiValue" placeholder="kpi当前值"/>
				</el-form-item>
				<el-form-item label="创建日期" prop="cdate">
					<el-date-picker type="date" placeholder="选择日期" v-model="editForm.cdate"  value-format="YYYY-MM-DD HH:mm:ss" format="YYYY-MM-DD" />
				</el-form-item>
				...
				<el-form-item label="考核方式0月1季度3半年4一年" prop="calcType">
					<el-input v-model="editForm.calcType" placeholder="考核方式0月1季度3半年4一年"/>
				</el-form-item>
				<el-form-item label="下次考核开始时间" prop="nextCalcDate">
					<el-date-picker type="date" placeholder="选择日期" v-model="editForm.nextCalcDate"  value-format="YYYY-MM-DD HH:mm:ss" format="YYYY-MM-DD" />
				</el-form-item>
				<el-form-item>
