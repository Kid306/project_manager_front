<template>
	<section>
		...
		<el-row class="footer">   
			...
			<el-button v-loading="load.edit" type="primary" @click="confirm" :disabled="load.edit==true">提交</el-button>   
		</el-row> 
	</section>
</template>
...
import {listCandidate,addCandidate } from '@/api/mdp/workflow/ru/task';  
